...
namespace Huff
{
    public class BassEngine : IWaveformPlayer, ISpectrumPlayer
    {
        ...
        private void waveformGenerateWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            {
                Bass.BASS_ChannelGetLevel(stream, levels,0.005f,BASSLevel.BASS_LEVEL_ALL);
        ...
        */
        ...
        public double TotalTime { get { return Bass.BASS_ChannelBytes2Seconds(ActiveStreamHandle, Bass.BASS_ChannelGetLength(ActiveStreamHandle)); } }
        public bool CanPlay
        {
            get { return canPlay; }
            protected set
